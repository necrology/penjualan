  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php if ($this->session->userdata('level') == 2) { ?>
        ...
        <!-- Nav Item - Tables persenan -->
        <li class="nav-item active">
          <a class="nav-link" href="<?= site_url() ?>option/data_persenan">
            <i class="fas fa-fw fa-percent"></i>
            <span>Data Persenan</span></a>
        </li>
        <!-- Divider -->
        <hr class="sidebar-divider my-0">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="h3 ml-auto">Data Pembagian Persen</div>
  ...
  <script>
    ...
    $(document).ready(function() {
      table = $('#tabelUser').DataTable({
        ...
        "serverSide": true,
        "ajax": {
          "url": "http://localhost/penjualan/option/get_data_persenan",
          "type": "POST"
        },
        "info": false,
        "lengthChange": true,
    ...
    function save() {
      var url;
      if (save_method == 'add') {
        url = "<?php echo site_url('option/simpan_persenan') ?>";
      } else {
        url = "<?php echo site_url('option/update_persenan') ?>";
      }
    ...
    function edit_data(id) {
      ...
      $('#form')[0].reset();
      $.ajax({
        url: "<?php echo site_url('option/edit_data') ?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          $('[name="id"]').val(data.id);
          $('[name="pihak"]').val(data.pihak);
          $('[name="persenan"]').val(data.persenan);

          $('#modal_form').modal('show');
          $('.modal-title').text('Edit Data Pembagian Persenan');
        },
        error: function(jqXHR, textStatus, errorThrown) {
          ...
          <form id="form" class="form-horizontal">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                <label for="nama" class="col-form-label">Pihak :</label>
                <input type="text" class="form-control " name="pihak" readonly="">
                <div class="invalid-feedback"></div>
              </div>

              <div class="form-group">
                <label for="email" class="col-form-label">Persenan (%) :</label>
                <input type="text" class="form-control " name="persenan" maxlength="2">
                <div class="invalid-feedback"></div>
              </div>
