...
class Model_barang extends CI_Model {
	...
	var $table = 'barang';
	var $column_order = array('kode_barang','nama_barang',null); //file table
	...
	// public function delete_by_id_barang($id_barang)
	// {
	...
	public function get_by_id_barang($id_barang)
	{
		$this->db->from($this->table);
		$this->db->where('id_barang',$id_barang);
		$query = $this->db->get();
	...
	public function cari_barang($key)
	{
		...
		$this->db->or_like('kode_barang', $key);
	...
	function insert_bulk_penjualan($array)
	{
		return $this->db->insert_batch('penjualan', $array); 
	}
